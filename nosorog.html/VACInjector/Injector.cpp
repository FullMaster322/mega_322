...
int main()
{
    ...
    GetFullPathName("C:/Users/zmajm/Desktop/menu/CSGO-CHEAT-DARWINTAP-main/Debug/darwinHook.dll", MAX_PATH, szPath, NULL);
   ...
   // Название вашей DLL
    ...
    std::cout << "FullMaster322 injected!" << std::endl;
    Sleep(3000);
    return 0;
}